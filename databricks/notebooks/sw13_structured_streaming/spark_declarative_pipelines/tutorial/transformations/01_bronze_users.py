...
# MAGIC
# MAGIC ## Your Task
# MAGIC Replace the `raise NotImplementedError(...)` line with a single statement that returns
# MAGIC the contents of `samples.wanderbricks.users`. The function name (`bronze_users`) becomes
# MAGIC the pipeline table name — keep it as is.
...
def bronze_users():
    # TODO: return the contents of samples.wanderbricks.users
    raise NotImplementedError("Implement bronze_users")
